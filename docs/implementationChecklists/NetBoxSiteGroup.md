# Implementation Checklist: NetBoxSiteGroup

**CRD:** `NetBoxSiteGroup`  
**Module:** `dcim/netbox_site_group.rs`  
**Reconciler:** `controllers/netbox/src/reconciler/dcim/site_group.rs`  
...
- [x] `site_group_needs_update()` function created
...
### Integration
- [x] Reconciler uses `site_group_needs_update()` function
...
### Testing
- [ ] Unit tests for `site_group_needs_update()` function
...
- ✅ **COMPLETED:** `site_group_needs_update()` function implemented (2026-01-03)
- ✅ **COMPLETED:** Drift detection logic added to `reconcile_netbox_site_group()` (2026-01-03)
- ✅ **COMPLETED:** Fixed comments field bug in idempotency path (2026-01-03)
