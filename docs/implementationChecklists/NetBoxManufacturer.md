# Implementation Checklist: NetBoxManufacturer

**CRD:** `NetBoxManufacturer`  
**Module:** `dcim/netbox_manufacturer.rs`  
**Reconciler:** `controllers/netbox/src/reconciler/dcim/manufacturer.rs`  
...
### Integration
- [x] Reconciler uses `manufacturer_needs_update()` function
...
### Testing
- [ ] Unit tests for `manufacturer_needs_update()` function
...
- Simple resource with only name, slug, description, comments, and tags
